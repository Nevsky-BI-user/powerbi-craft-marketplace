...
### Escaping has TWO levels — do not merge them
...
## Power BI Object Sizing (Prevent Scrollbars)
...
### HTML Content host: wrapper margins + card inset (verified in PDP, 2026-07-28)
...
### Backing plate + internal padding — put them in the report, not in the DAX
...
## DAX String Construction Patterns
...
## Layering: never overlap on top of transparent / `fill='none'`
