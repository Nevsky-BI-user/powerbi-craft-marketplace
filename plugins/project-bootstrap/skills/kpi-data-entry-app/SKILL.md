...
- **Назви показників, статусів і кнопок** — із доменних словників скіла
  [[dashboard-copy]] (`references/domains/`: фінанси, HR, логістика й
  виробництво, сервіс). Одна назва показника — одна одиниця й одна шкала в
  усьому застосунку; підпис без одиниці не приймається.
