...
SOURCE_META = {
    ...
    "local": {
        ...
        "note": "Ці скіли написані під власний робочий процес і публічного репозиторію не мають. "
                "На картці кожного є промпт: скопіюйте його в Claude Code, і той знайде "
                "щось подібне або відтворить скіл за описом.",
    },
}
